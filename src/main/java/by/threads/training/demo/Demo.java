package by.threads.training.demo;

import by.threads.training.workflow.Worker;
import by.threads.training.workflow.Stage;
...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        List<Runnable> runList = IntStream.range(0, WORKERS_AMOUNT).mapToObj(i -> (Runnable) () -> {
            try {
